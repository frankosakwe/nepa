...
import SocialShareSimple from './SocialShareSimple';
import { ShareableContent } from './SocialShareSimple';
...
describe('SocialShareSimple Component', () => {
  ...
  it('renders social sharing interface', () => {
    render(<SocialShareSimple content={mockContent} onAnalytics={mockAnalytics} />);
  ...
  it('handles different content types correctly', () => {
    ...
    render(<SocialShareSimple content={achievementContent} onAnalytics={mockAnalytics} />);
  ...
  it('handles eco impact content type', () => {
    ...
    render(<SocialShareSimple content={ecoContent} onAnalytics={mockAnalytics} />);
  ...
  it('handles savings milestone content type', () => {
    ...
    render(<SocialShareSimple content={savingsContent} onAnalytics={mockAnalytics} />);
  ...
  it('applies custom className when provided', () => {
    ...
    render(<SocialShareSimple content={mockContent} onAnalytics={mockAnalytics} className={customClass} />);
  ...
  it('works without analytics callback', () => {
    render(<SocialShareSimple content={mockContent} />);
